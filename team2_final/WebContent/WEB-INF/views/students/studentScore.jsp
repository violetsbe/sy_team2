			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/students/studentOS?open_course_id=${oc.open_course_id}">수강생의 과목</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/students/studentTestPoint?open_course_id=${oc.open_course_id}&open_sub_id=${os.open_sub_id}">수강생과목의 시험</a></li>
						<li><a>></a></li>
						<li><a href="#">수강생의 점수</a></li>
					</ul>
				</div>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr class="bgColor01">
										<th class="center col-md-1">시험아이디
										</th>
										<th class="center col-md-1">시험날짜
										</th>
										<th class="center col-md-1">출결배점
										</th>
										<th class="center col-md-1">필기배점
										</th>
										<th class="center col-md-1">실기배점
										</th>
										<th class="center col-md-1">시험문제
										</th>
									</tr>
								</thead>
								<tbody>
								...
								<tbody>
									<c:forEach var = "s" items="${list}">
										<tr>
											...
											<td class="center">${s.practice_score}</td>
											<td class="center">${s.written_score}</td>
											<td class="center">${s.total_score}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
