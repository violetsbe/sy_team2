				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<input type="hidden" id="osid" value="${os.open_sub_id}">
							<!-- 자료 개수 출력 버튼 시작 -->
							<!-- 전체 자료 개수 -->
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/students/studentScore?open_course_id="+$("#ocid").val()+"&open_sub_id="+$("#osid").val()+"&test_id="+$(this).val());
			});
