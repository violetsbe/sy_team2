			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/score/student4">시험 선택</a></li>
						<li><a>></a></li>
					</ul>
				</div>
								...
								<tbody>
										<c:forEach var="t" items="${list}">
											<tr>
												...
												<td class="center">
											<button class="btn btn-default btn-primary btn-xs" title="${t.test_q}">다운로드</button>
										</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnTest" value="${t.test_id}">선택</button>
										</td>
											</tr>
										</c:forEach>
									</tbody>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnTest").on("click", function(){
				...
				var open_sub_id = $(".open_sub_id").find("td:eq(0)").text();
				var student_id = $(".student_id").find("td:eq(0)").text();
				window.location.assign("${pageContext.request.contextPath}/admin/score/student5?student_id="
						+student_id+"&open_course_id="+open_course_id+"&open_sub_id="+open_sub_id+"&test_id="+$(this).val());
			});
