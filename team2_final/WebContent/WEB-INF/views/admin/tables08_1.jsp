			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/student/course">과정등록</a></li>
					</ul>
				</div>
					...
					<!-- <div class="panel-heading">과정 관리 테이블</div> -->
						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover" id="tableStudent">
								...
								<tbody>
									...
									<tr>
										...
										<td class="center"><a href="#" data-toggle="popover"
													...
													class="pop1"
													data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/Fotolia07.png'style='width:60%;'><div>">${student.student_name}</a></td>
								...
								<!-- <div class="col-md-2">
									<select class="form-control" id="maxPage" name="maxPage">
							...
							<table class="table table-bordered table-hover" id="possibleCourse">
								...
								<c:forEach var="oc" items="${openCourse}">	
									<tr>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnCourseAdd" data-toggle="modal" data-target="#openCourseAdd">선택</button>
									</tr>
								</c:forEach>	
								 </tbody>
							</table>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- 내용 -->
					<form action="${pageContext.request.contextPath}/admin/courseHistory/add" method="post">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnCourseAdd").on("click", function(){
				...
				$("#openCourseAdd #open_course_id").val(oc_id);
				$("#openCourseAdd #course_name").val(oc_name);
				$("#openCourseAdd #course_start_date").val(course_start);
				$("#openCourseAdd #course_end_date").val(course_end);
				$("#openCourseAdd #room_name").val(room);
