				...
				<!-- <div class="panel panel-default">
					...
					<!-- <div class="panel-heading">과정 관리 테이블</div> -->
						...
						<div class="panel-body">
									...
									<tbody>
										<c:forEach var="student" items="${list}">
											<tr>
												...
												<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnStudent"
											value="${student.student_id}">선택</button>
											</td>
											</tr>
										</c:forEach>
									</tbody>
							...
							<form action="${pageContext.request.contextPath}/admin/score/student" class="form-inline" method="POST">
								<div class="form-group">
									...
									<select class="form-control input-sm" id="key" name="key">
										...
										<option value="s_reg_date">등록일</option>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnStudent").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/admin/score/student2?student_id="+$(this).val());
			});
			...
			$("#btnPrevious").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/admin/score/student?pageNum_="+pageNum);
			});
