									...
									<tbody>
										<c:forEach var="oc" items="${list}">
											<tr>
												...
												<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnCourse"
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnCourse").on("click", function(){
				...
				window.location.assign("${pageContext.request.contextPath}/admin/score/student3?open_course_id="+$(this).val()+"&student_id="+student_id);
			});
