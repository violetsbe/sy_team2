	...
	<script>
		$(document).ready(function() {
			...
			$(".btnTest").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/admin/score/subject3?open_course_id="+ open_course_id +"&open_sub_id="+$(this).val());
			});
		 	...
		 	$("a[rel]").on("mouseover", function(){
	    		...
	    		$.ajax({
	    			...
	    			,success: function(data_) {
	    				...
	    				//var bbb = "<div style='text-align:center;'><img src='"+ coverLargeUrl +"' style='width:60%;'><div>"
	    				/* var dataContent =
	    					 "<table>=<tr><td style='width:60px;'>제목</td><td>"+title 
	    					+"</td></tr><tr><td>저자</td><td>" + author
	    					+"</td></tr><tr><td>가격</td><td>"+ priceStandard
	    					+"</td></tr><tr><td>출판사</td><td>" + publisher 
	    					+"</td></tr><tr><td>ISBN</td><td>"+ isbn + "</td></tr></table>";  */
	    					var dataContent = 
	    						"<img src='" + coverLargeUrl + "'><div><ul><li>저자 : " + author + 
	    						"</li><li>가격 : " + priceStandard + "원 </li><li>출판사 : " + publisher + "</li></ul></div>";
	    					
	    				$(s).attr("data-content", dataContent);
	    				$(s).attr("title", "<img src='"+ coverLargeUrl +"' style='width:60%;'>");
	    			}});
				}); 
