...
<body>
   ...
   <div id="wrapper">
			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/course/list">기초정보관리</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/course/list">과정관리</a></li>
					</ul>
				</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover"
								...
								<thead>
									<tr class="bgColor01">
										<th class="center col-md-3">과정 아이디</th>
										<th class="center col-md-5">과정명</th>
									...
									<tbody>
										<c:forEach var="c" items="${list}">
											<tr>
												<td class="center col-md-3">${c.course_id}</td>
										<td class="center col-md-5">${c.course_name}</td>
									
										
										
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnModify"
												data-toggle="modal" data-target="#modifyCourseModal">수정</button>
										</td>
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnDelete"  ${c.count_ == 0 ? "" : "disabled=\"disabled\""}
												data-toggle="modal" data-target="#deleteCourseModal">삭제</button>
										</td>
									</tr>
										</c:forEach>
										</tbody>
	...
	<div id="addCourseModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- 내용 -->
					<form action="${pageContext.request.contextPath}/admin/course/insert" method="post">
		...
		<!-- Modal 모달 관련 -->
	<div id="modifyCourseModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
				...
				<div class="modal-body">
					<!-- 내용 -->
					  <form action="${pageContext.request.contextPath}/admin/course/update" method="post">
						<div class="form-group">
							<label for="classroom_id">과정 아이디</label> <input type="text"
                        class="form-control" id="course_id" name="course_id"
                        placeholder="course_id" readonly="readonly">
	...
	<div id="deleteCourseModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <!-- 내용 -->
             	<form action="${pageContext.request.contextPath}/admin/course/delete" method="post">
                  <div class="form-group">
                     <label for="course_id">과정 아이디</label> <input type="text"
                        class="form-control" id="course_id" name="course_id"
                        placeholder="course_id" readonly="readonly"></div>
                        <div class="form-group">
                        <label for="course_name">과정명</label> <input type="text"
                        class="form-control" id="course_name" name="course_name"
                        placeholder="course_name" readonly="readonly"></div>
                        
                     <div>
                     
                        <p>현재 선택한 과정을 삭제하시겠습니까?</p>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnDelete").on("click", function() {
                 ...
                 var txt = "";
                 $("#deleteCourseModal #course_id").val(course_id);
                 $("#deleteCourseModal #course_name").val(course_name);
                           });
			...
			$(".btnModify").on("click", function() {
                ...
                var course_name = $(this).parents("tr").find("td:eq(1)").text();
                var txt = "";
                $("#modifyCourseModal #course_id").val(course_id);
                $("#modifyCourseModal #course_name").val(course_name);
                          });
