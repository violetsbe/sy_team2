			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/classroom/list">기초정보관리</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/admin/classroom/list">강의실관리</a></li>
					</ul>
				</div>
								...
								<thead>
									...
									<tbody>
										<c:forEach var="r" items="${list}">
											<tr>
												<td class="center col-md-2">${r.room_id}</td>
										<td class="center col-md-3">${r.room_name}</td>
										<td class="center col-md-3">${r.room_capacity}</td>
										...
										<td class="center">
											<button class="btn btn-defualt btn-primary btn-xs btnDelete"  ${r.count_ == 0 ? "" : "disabled=\"disabled\""}
		...
		<div id="addCourseModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<!-- 내용 -->
						<form action="${pageContext.request.contextPath}/admin/classroom/insert" method="post">
							<div class="form-group">
								<label for="room_name">강의실명</label> <input type="text"
									...
									<div class="form-group">
									<label
									for="room_capacity">수용인원</label> <input type="text"
									class="form-control" id="room_capacity"
									name="room_capacity" placeholder="최대 20자" required>
							</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<!-- 내용 -->
						<form action="${pageContext.request.contextPath}/admin/classroom/update" method="post">
							<div class="form-group">
								<label for="room_id">강의실 아이디</label> <input type="text"
							...
							<div class="form-group">
								<label for="room_capacity">수용인원</label> <input type="text"
									class="form-control" id="room_capacity"
									name="room_capacity"
									value="">
							</div>
		...
		<div id="deleteClassroomModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<!-- 내용 -->
						<form action="${pageContext.request.contextPath}/admin/classroom/delete" method="post">
							<div class="form-group">
								<label for="room_id">강의실 아이디</label> <input type="text"
									class="form-control" id="room_id" name="room_id"
									readonly="readonly">
										...
										.on(
												...
												function() {
													...
													var classroom_capacity = $(
															...
															.text();
													$(
															"#deleteClassroomModal #room_id")
															.val(classroom_id);
													$(
															"#deleteClassroomModal #room_name")
															.val(classroom_name);
													$(
															"#deleteClassroomModal #room_capacity")
															.val(
																	classroom_capacity);
								...
								.on(
										...
										function() {
											...
											var classroom_capacity = $(
													...
													.text();
											$(
													"#modifyClassroomModal #room_id")
													.val(classroom_id);
											$(
													"#modifyClassroomModal #room_name")
													.val(classroom_name);
											$(
													"#modifyClassroomModal #room_capacity")
													.val(
															classroom_capacity);
