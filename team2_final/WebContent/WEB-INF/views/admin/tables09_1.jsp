			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/score/subject">과목별
								성적조회</a></li>
						<li><a>></a></li>
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<table class="table table-bordered table-hover"
									...
									<thead>
										<tr class="bgColor01">
											<th class="center">개설과정<br>아이디
											</th>
											<th class="center">개설<br>과정명
											</th>
											<th class="center">개설과정<br>시작일
											</th>
											<th class="center">개설과정<br>종료일
											</th>
										...
										<c:forEach var="oc" items="${list}">
											<tr>
												...
												<td class="center"><button
														class="btn btn-defualt btn-primary btn-xs btnCourse"
						...
						function() {
							...
							$(".btnCourse")
									.on(
											...
											function() {
												window.location
														.assign("${pageContext.request.contextPath}/admin/score/subject2?open_course_id="
																+ $(this).val());
											});
						});
	</script>
