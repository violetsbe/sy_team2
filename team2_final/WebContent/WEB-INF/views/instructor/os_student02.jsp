		...
		<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/os_student01">강의스케쥴조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/os_student01">개설과정별 전체 수강생 조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/os_student01">개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a href="#">전체 수강생 조회</a></li>
									...
									<c:forEach var="s" items="${sList}">
										<tr>
											...
											<td class="center">
											   ...
											   data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/pictures/student/${s.s_file_name==null?"person-placeholder.jpg":s.s_file_name}' style='width:60%;'><div>">${s.student_name}</a>
											</td>
											<td class="center ">${s.phone}</td>
											<td class="center">${s.s_reg_date}</td>
											<td class="center">${s.s_status}</td>
											<td class="center">${s.s_course_end_date}</td>
										</tr>
									</c:forEach>
