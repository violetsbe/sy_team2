					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a href="${pageContext.request.contextPath}/instructor/schedule_planned01">강의예정</a></li>
								<li><a href="${pageContext.request.contextPath}/instructor/schedule_ing01">강의중</a></li>
								<li><a href="${pageContext.request.contextPath}/instructor/schedule_end01">강의종료</a></li>
							</ul>
	                     ...
	                     <form class="form-inline" action="${pageContext.request.contextPath}/instructor/schedule_planned01" method="POST">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/instructor/schedule_planned02?open_course_id="+open_course_id);
			});
