			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/instructor/schedule_planned01">강의예정
								개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a
							href="#">강의예정
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a
									href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의
										예정</a></li>
