						...
						<c:forEach var="oc" items="${list}">
								...
								<thead>
									<tr class="bgColor01">
										...
										<th class="center ">현재<br>수강<br>인원</th>
										<th class="center ">중도<br>포기<br>인원</th>
										<th class="center ">수강<br>신청<br>인원</th>
								...
								<tbody>
									<tr>
										...
										<td class="center ">${oc.current_student}</td>
										<td class="center ">${oc.abandon_student}</td>
								...
								<table class="table table-bordered table-hover"
									...
									<thead>
										<tr class="bgColor02">
											<th class="center">개설과목아이디</th>
											<th class="center">개설과목명</th>
											<th class="center">개설과목시작일</th>
											<th class="center">개설과목종료일</th>
											<th class="center">교재명</th>
											<th class="center">진행현황</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="os" items="${oc.subjectList}"> 
											<tr>
												<td class="center">${os.open_sub_id}</td>
												<td class="center">${os.subject_name}</td>
												<td class="center">${os.sub_start_date}</td>
												<td class="center" style="vertical-align: middle;">${os.sub_end_date}</td>
												...
												<td class="center" style="vertical-align: middle;">
													<div class="progress">
														<div class="progress-bar progress-bar-custom" 
															role="progressbar" aria-valuenow="${os.progress}" aria-valuemin="0"
															aria-valuemax="100" style="width: ${os.progress}%;">${os.progress}%</div>
													</div>
												</td>
											</tr>
										</c:forEach>
