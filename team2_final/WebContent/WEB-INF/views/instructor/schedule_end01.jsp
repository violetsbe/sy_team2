			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="#${pageContext.request.contextPath}/instructor/schedule_planned01">강의스케쥴조회</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/schedule_planned01">강의 일정별 조회</a></li>
						<li><a>></a></li>
						<li><a href="#">강의종료 개설과정 선택</a></li>
...
<%-- 								<li ><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의 예정</a></li>
								<li><a href="${pageContext.request.contextPath}/views/instructor/schedule_ing01.jsp">강의 중</a></li> --%>
								<li class="active"><a href="${pageContext.request.contextPath}/instructor/schedule_end01">강의 종료</a></li>
							</ul>
                     ...
                     <form class="form-inline" action="${pageContext.request.contextPath}/instructor/schedule_end01" method="POST">
                        <div class="form-group">
                           ...
                           <button type="button" class="btn btn-default btn-sm">
                              페이지 <span class="badge" id="pageNum">${pageNum}</span>
                           </button>
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/instructor/schedule_end02?open_course_id="+open_course_id);
			});
