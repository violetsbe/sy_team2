		...
		<div id="page-wrapper">
				<div class="row">
					...
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/schedule_planned01">강의일정별 조회</a></li>
						<li><a>></a></li>
						<li><a href="#">강의중 개설과정 선택</a></li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<%-- 	<li ><a href="${pageContext.request.contextPath}/views/instructor/schedule_planned01.jsp">강의 예정</a></li> --%>
								<li class="active"><a href="${pageContext.request.contextPath}/views/instructor/schedule_ing01.jsp">강의 중</a></li>
                     ...
                     <form class="form-inline" action="${pageContext.request.contextPath}/instructor/schedule_ing01" method="POST">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/instructor/schedule_ing02?open_course_id="+open_course_id);
			});
