			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/instructor/schedule_planned01">강의
								일정별 조회</a></li>
						<li><a>></a></li>
						<li><a
							href="${pageContext.request.contextPath}/instructor/schedule_end01">강의종료
								개설과정 선택</a></li>
						<li><a>></a></li>
						<li><a
							href="#">강의종료
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a
									href="${pageContext.request.contextPath}/instructor/schedule_end01">강의
										종료</a></li>
							</ul>
