...
<%-- 								<tbody>
									<tr >
										...
										<td class="center"><button type="button" class="btn btn-primary btn-xs btnView">선택</button></td>

									</tr>
									<tr >
										<td class="center ">S018</td>
										<td class="center">
										   <a href="#" data-toggle="popover" data-placement="left" data-trigger="hover" data-html="true" class="pop1" 
										   data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/img/person-placeholder.jpg' style='width:60%;'><div>">아무개</a>
										</td>
								...
								<tbody>
									<c:forEach var="student" items="${list}">
										<tr>
											...
											<td class="center">
											   <a href="#" data-toggle="popover" data-placement="left" data-trigger="hover" data-html="true" class="pop1" 
											   data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/pictures/student/${student.s_file_name==null?"person-placeholder.jpg":student.s_file_name}' style='width:60%;'><div>">${student.student_name}</a>
											</td>
											<td class="center ">${student.phone}</td>
											<td class="center ">${student.s_reg_date}</td>
											<td class="center ">
												<button type="button" class="btn btn-primary btn-xs btnView" value="${student.student_id}">선택</button>
											</td>
										</tr>
									</c:forEach>
							...
							<form class="form-inline" method="POST" action="${pageContext.request.contextPath}/instructor/scoreCheck_student01">
		...
		$(document).ready(function() {
			...
			$("[data-toggle='popover']").popover();
	         ...
	         $(".btnView").on("click", function() {
	             ...
	             window.location.assign("${pageContext.request.contextPath}/instructor/scoreCheck_student02?student_id="+student_id);
	          });
				...
				$("#btnPrevious").on("click", function() {
					...
					window.location.assign("${pageContext.request.contextPath}/instructor/scoreCheck_student01?pageNum_="+pageNum);
				});
