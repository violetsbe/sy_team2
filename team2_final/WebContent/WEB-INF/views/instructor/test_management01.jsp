			...
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/test_management01">개설과정 선택</a></li>
					</ul>
				</div>
			</div>
			<!-- 콘텐츠 상단 네비게이션 바 끝 -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-inline" method="POST" action="${pageContext.request.contextPath}/instructor/test_management01">
								<div class="form-group">
									...
									<button type="button" class="btn btn-default btn-sm" id="Num" value="${pageNum}">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/instructor/test_management02?open_course_id="+$(this).val());
			});
			
			//Previous 버튼 액션
			$("#btnPre").on("click", function() {
				window.location.assign("${pageContext.request.contextPath}/instructor/test_management01?pageNum_="+$(this).val());
			});
