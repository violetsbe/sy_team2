			...
			<div class="row content">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
                     ...
                     <form class="form-inline" action="${pageContext.request.contextPath}/instructor/os_student01" method="POST">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btnView").on("click", function() {
				...
				window.location.assign("${pageContext.request.contextPath}/instructor/os_student02?open_course_id="+open_course_id);
			});
