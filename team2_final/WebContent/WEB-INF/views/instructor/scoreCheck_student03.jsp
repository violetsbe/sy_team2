					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover"
								...
								<thead>
									<tr class="bgColor02">
		                              <th class="center" style="width:10%">개설과목<br>아이디</th>
		                              <th class="center" style="width:8%">개설<br>과목명</th>
		                              <th class="center" style="width:10%">개설과목<br>시작일</th>
		                              <th class="center" style="width:10%">개설과목<br>종료일</th>
		                              <th class="center" style="width:8%">교재명</th>
		                              <th class="center" style="width:2%">보기</th>
		                           </tr>
								</thead>
<%-- 								<tbody>
									<tr>
								...
								<tbody>
									<c:forEach var="os" items="${list}">
										<tr>
									    	...
									    	<td class="center ">
											<button type="button" class="btn btn-primary btn-xs btnView" value="${os.open_sub_id}">선택</button>
											</td>
										</tr>
									</c:forEach>
			...
			$("a[rel]").on("mouseover", function(){
	         ...
	         $("#btnInfo").on("click", function() {
	          ...
	          $(".btnView").on("click", function() {
	              ...
	              window.location.assign("${pageContext.request.contextPath}/instructor/scoreCheck_student04?open_sub_id="+open_sub_id);
	           }); 
