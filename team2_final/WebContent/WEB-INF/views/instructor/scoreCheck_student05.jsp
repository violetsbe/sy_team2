	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="" id="nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="#">성적관리</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student01">수강생기준</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student01">수강생 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student02?student_id=${choiceInsList.student_id}">개설과정 선택</a></li>
			
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student03?open_course_id=${choiceInsList02.open_course_id}">개설과목 선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student04?open_sub_id=${choiceInsList03.open_sub_id}">시험선택</a></li>
						<li><a>></a></li>
						<li><a href="${pageContext.request.contextPath}/instructor/scoreCheck_student05">특정수강생 성적관리</a></li>
					</ul>
				</div>
			...
			<div class="row content">
				<div class="col-lg-12">		
					<h2>특정수강생 성적관리</h2>
					<div class="panel panel-default panel_temp01">
						...
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover student_table_temp"
								id="tableOpenCourse">
								<thead>
									<tr class="bgColor01">
...
<%-- 								<tbody>
									<tr >
										...
										<td class="center ">010-0000-0000</td>
								...
								<tbody>
										<tr>
											<td class="center ">${choiceInsList.student_id}</td>
											<td class="center">
											   <a href="#" data-toggle="popover" data-placement="left" data-trigger="hover" data-html="true" class="pop1" 
											   data-content="<div style='text-align:center;'><img src='${pageContext.request.contextPath}/resources/pictures/student/${choiceInsList.s_file_name==null?"person-placeholder.jpg":choiceInsList.s_file_name}' style='width:60%;'><div>">${choiceInsList.student_name}</a>
											</td>
											<td class="center ">${choiceInsList.phone}</td>
											<td class="center ">${choiceInsList.s_reg_date}</td>
										</tr>
								</tbody>									
						...
						<table class="table table-bordered table-hover"
								...
								<thead>
									<tr class="bgColor01">
										...
										<th class="center ">수료<br>상태</th>
										<th class="center ">수료<br>상태<br>날짜</th>
...
<!-- 								<tbody>
								...
								<tbody>
										<tr>
											<td class="center ">${choiceInsList02.open_course_id}</td>
											<td class="center ">${choiceInsList02.course_name}</td>
											<td class="center ">${choiceInsList02.course_start_date}</td>
											<td class="center ">${choiceInsList02.course_end_date}</td>
											<td class="center ">${choiceInsList02.room_name}</td>
											<td class="center ">${choiceInsList02.total_student}</td>
											<td class="center ">${choiceInsList02.s_status}</td>
											<td class="center ">${choiceInsList02.s_course_end_date}</td>											
										</tr>
								</tbody>									
							</table>
							<!-- /.table-responsive -->
...
<%-- 								<tbody>
								...
								<tbody>
										<tr>
											<td class="center ">${choiceInsList03.open_sub_id}</td>
											<td class="center ">${choiceInsList03.subject_name}</td>
											<td class="center ">${choiceInsList03.sub_start_date}</td>
											<td class="center ">${choiceInsList03.sub_end_date}</td>
											<td class="center" style="vertical-align: middle;"><a href="#" rel="${choiceInsList03.isbn}" 
											   data-toggle="popover" data-placement="left" 
											   data-html="true" class="pop1" 
											   data-content=''>${choiceInsList03.book_name}</a>
											</td>
										</tr>
								</tbody>									
...
<!-- 								<tbody>
								...
								<tbody>
										<tr>
											<td class="center ">${choiceInsList04.test_id}</td>
											<td class="center ">${choiceInsList04.test_date}</td>
											<td class="center ">${choiceInsList04.attendance_points}</td>
											<td class="center ">${choiceInsList04.written_points}</td>
											<td class="center ">${choiceInsList04.practice_points}</td>
											<td class="center">
												<button type="button" class="btn btn-primary btn-xs btnDown"  title="${choiceInsList04.test_q}" ${choiceInsList04.test_q!=null?"":"disabled='disabled'"} value="${choiceInsList04.test_q}">다운로드</button>
											</td>
										</tr>
								</tbody>									
							</table>
					...
					<div class="panel panel-default panel_temp02">
						<div class="panel-body">
							...
							<table class="table table-bordered table-hover"
								...
								<thead>
									<tr class="bgColor02">
										...
										<th class="center col-md-3" >등록/삭제</th>	
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<!-- 내용 -->
					<form action="${pageContext.request.contextPath}/instructor/addScore02" method="post">
   ...
   <div id="removeScoreModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <!-- 내용 -->
               <form action="${pageContext.request.contextPath}/instructor/removeScore02" method="post">
						<div class="form-group">
                  ...
                  <p>현재 선택한 수강생의 점수를 삭제하시겠습니까?</p>   
	               ...
	               <div class="row">
	                  ...
	                  <div class="col-md-6 right">
	                     <button type="submit" class="btn btn-default" id="btnAddCourse">삭제</button>
	                  </div>
	               </div>
               </form>
		...
		$(document).ready(function() {
	        ...
	        $(".btnDown").on("click", function() {
				...
				//점수 등록 모달
	 	        ...
	 	        /* 	var student_id = $(this).parents(".panel_temp02").siblings(".panel_temp01").eq(0).find("td:eq(0)").text(); */
	 	            var student_id = $(this).parents(".panel_temp02").siblings(".panel_temp01").find("td:eq(0)").text();
	 	        	$("#addScoreModal #student_id").val(student_id);
	 	        	
	 	        	var student_name = $(this).parents(".panel_temp02").siblings(".panel_temp01").find("td:eq(1)").find("a").text();
	 	        	$("#addScoreModal #student_name").val(student_name);
	 	        	
	 	        	var phone = $(this).parents(".panel_temp02").siblings(".panel_temp01").find("td:eq(2)").text();
				...
				//점수 삭제 모달
	 			$(".btnScoreRemove").on("click", function(){
	 	        	...
	 	        	var attendance_score = $(this).parents("tr").find("td:eq(0)").text();
	 	        	$("#removeScoreModal #attendance_score").val(attendance_score);
	 	        	
	 	        	var written_score = $(this).parents("tr").find("td:eq(1)").text();
	 	        	$("#removeScoreModal #written_score").val(written_score);
	 	        	
	 	        	var practice_score = $(this).parents("tr").find("td:eq(2)").text();
