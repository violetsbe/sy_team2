...
public interface OpenCourseDAO {
	...
	//강사 - 강의스케쥴조회>강의일정별 조회>강의예정 과정조회		#BR		#BR
	public List<OpenCourse> plannedList(String pro_id);
	
	//강사 - 강의스케쥴조회>강의일정별 조회>강의중	과정조회		#BR		#BR
	public List<OpenCourse> ingList(String pro_id);
		
	//강사 - 강의스케쥴조회>강의일정별 조회>강의종료 과정조회		#BR		#BR
	...
	//강사 - 개설과정별 전체수강생 조회(담당 전체 과정 리스트)	#BR	20190106	20190106
